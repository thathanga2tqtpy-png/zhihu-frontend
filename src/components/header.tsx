              ...
              <SheetContent side="left" className="w-[300px] sm:w-[350px] p-0">
                <div className="flex flex-col h-full bg-background">
                  <SheetHeader className="p-6 border-b text-left">
                    <SheetTitle className="font-serif italic text-primary text-xl">
                      Niềm Vui Thoáng Qua
                    </SheetTitle>
                  </SheetHeader>
                      ...
                      {user ? (
                        <div className="space-y-3">
                          ...
                          <div className="grid grid-cols-1 gap-1">
                            <Link
                              href="/profile"
                              className="flex items-center gap-3 p-2 text-sm hover:bg-muted rounded-lg transition-colors"
                            >
                            ...
                            <Button
                              ...
                              className="justify-start gap-3 px-2 text-red-500 hover:text-red-600 hover:bg-red-50"
                            >
              ...
              <div className="hidden md:flex items-center gap-2">
                <Link href="/login">
                  <Button
                    variant="ghost"
                    size="sm"
                    className="h-8 rounded-full px-4 text-[11px] font-bold uppercase tracking-wider"
                  >
                    Đăng nhập
                  </Button>
                </Link>
                <Link href="/register">
                  <Button
                    variant="outline"
                    size="sm"
                    className="h-8 rounded-full px-5 text-[11px] font-bold uppercase tracking-wider border-2 hover:bg-primary hover:text-white transition-all"
                  >
                    Đăng ký
                  </Button>
                </Link>
